...
import runData from '../FileJson/sit.json';
import fruitData from '../FileJson/ring.json';
import otherData from '../FileJson/home.json';
import leg from '../FileJson/leg.json';
import neck from '../FileJson/neck.json';
import wid from '../FileJson/wid.json';

const IndoorActivitiesPage = () => {
