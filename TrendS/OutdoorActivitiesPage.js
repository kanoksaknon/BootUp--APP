...
import runData from '../FileJson/run.json';
import fruitData from '../FileJson/shoes.json';
import otherData from '../FileJson/ban.json';
import walk from '../FileJson/walk.json';
import ar from '../FileJson/ar.json';
import lo from '../FileJson/lo.json';
